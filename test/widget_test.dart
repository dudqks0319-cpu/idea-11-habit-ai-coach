...
import 'package:app_11_habit_ai_coach/app.dart';
import 'package:app_11_habit_ai_coach/services/supabase_service.dart';
...
void main() {
  testWidgets('회원가입 후 할 일을 추가하고 추천 목록에서 확인할 수 있다', (tester) async {
    ...
    expect(find.text('AI 습관 코칭'), findsWidgets);
